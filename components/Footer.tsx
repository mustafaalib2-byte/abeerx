        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href={`/${locale}/shop`} className="text-muted-foreground hover:text-ring transition-colors">{isArabic ? "التسوق" : "Shop"}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href={`/${locale}/returns-refunds`} className="text-muted-foreground hover:text-ring transition-colors">{isArabic ? "الاسترجاع والاسترداد" : "Returns & Refunds"}</Link></li>
              ...
              <li><Link href={`/${locale}/request-fragrance`} className="text-muted-foreground hover:text-ring transition-colors">{isArabic ? "اطلب عطراً" : "Request a fragrance"}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-muted-foreground">
              <li className="leading-relaxed">
                {isArabic ? "مدينة الكويت - المباركية، الغربللي، بالقرب من مركز لؤلؤة - محل رقم 7" : "KUWAIT CITY-AL-MUBARAKIYAH, GHARABALLY, NEAR LULUWA CENTER - SHOP NO. 7"}
              </li>
              <li>
